  ...
  return (
    ...
    >
      ...
      <ol className="list-decimal pl-6 space-y-2">
        <li>
          <strong>Share Your Need:</strong> Select or describe your circumstance.
        </li>
        <li>
          <strong>Scripture Speaks:</strong> JirehFaith finds Bible passages that
          directly reflect your situation.
        </li>
        <li>
          <strong>Prayer is Formed:</strong> A heartfelt prayer is generated,
          rooted in the Word, shaped to inspire faith and trust in God’s
          provision.
        </li>
      </ol>
      <p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Scripture First:</strong> Every prayer is anchored in the Bible.
        </li>
        <li>
          <strong>Emotionally Attuned:</strong> Through the Default Human Logic
          Layer (DHLL), prayers are shaped with sensitivity to real human
          emotions.
        </li>
        <li>
          <strong>Multi-Language:</strong> Available in English, French, Spanish,
          and Portuguese.
        </li>
        <li>
          <strong>Accessible for All:</strong> Free daily prayers, with
          subscriptions and donations helping sustain the mission.
        </li>
      </ul>
      ...
      <p className="mt-6 font-semibold">God’s Blessings be upon you always!</p>
            <div className="mt-8">
        <a
          href="/tech-info"
